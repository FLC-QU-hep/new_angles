...
def main():
    ...
    params = {'model':               
              ...
              '3D_M_BiBAEBatchS_Energy_Angle_P_None_C_BatchSV2Core_CL_Default_30x30x60Thresh_Reset_No_LNorm_PP_ESum_CALIB',
              
              
              'suffix': 'Test_PP',   # 500000 showers- 6 conv PP layers
